%Codigo del carro
% Trabajo Practico 2 - Item 4 - 2023
% Alumno: Jorge Omar Sosa

%clear all, close all, clc
%Variables
m=.1; Fricc=0.1; long=1.6;g=9.8;M=1.5;
h=0.005; tiempo=(80/h); delta_pp=0;phi_pp=0; 
...
R=600; %Si achico R tiende a ser mas rapida la respuesta, o tambien voy aumentando Q
...
subplot(3,1,3);plot(t(1:end),u,color);grid on; title('Accion de control, u');xlabel('Tiempo en seg');hold on;
